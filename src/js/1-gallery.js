...
'simplelightbox/dist/simple-lightbox.min.css'; const images = [ { preview:
...
`; }) .join(''); galleryContainer.innerHTML = galleryMarkup; new
SimpleLightbox('.gallery a', { captionsData: 'alt', captionsDelay: 250, });
